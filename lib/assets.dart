...
enum GameImageAsset {
  ...
  map_icon_bridge_east_west('map/icons/Narrasil Bridge East-West.png'),
  map_icon_bridge_north_south('map/icons/Narrasil Bridge North-South.png'),
  map_icon_castle('map/icons/Narrasil Castle.png'),
  map_icon_castle_2('map/icons/Narrasil Castle 2.png'),
  map_icon_city('map/icons/Narrasil City.png'),
  map_icon_city_2('map/icons/Narrasil City 2.png'),
  map_icon_crevasse('map/icons/Narrasil Crevasse.png'),
  map_icon_dead_tree_1('map/icons/Narrasil Dead Tree 1.png'),
  map_icon_dead_tree_2('map/icons/Narrasil Dead Tree 2.png'),
  map_icon_dunes('map/icons/Narrasil Dunes.png'),
  map_icon_fortress('map/icons/Narrasil Fortress.png'),
  map_icon_hamlet('map/icons/Narrasil Hamlet.png'),
  map_icon_hill_1('map/icons/Narrasil Hill 1.png'),
  map_icon_hill_2('map/icons/Narrasil Hill 2.png'),
  map_icon_hill_3('map/icons/Narrasil Hill 3.png'),
  map_icon_hill_4('map/icons/Narrasil Hill 4.png'),
  map_icon_hill_5('map/icons/Narrasil Hill 5.png'),
  map_icon_hill_6('map/icons/Narrasil Hill 6.png'),
  map_icon_jungle_tree_1('map/icons/Narrasil Jungle Tree 1.png'),
  map_icon_jungle_tree_2('map/icons/Narrasil Jungle Tree 2.png'),
  map_icon_jungle_tree_3('map/icons/Narrasil Jungle Tree 3.png'),
  map_icon_marsh('map/icons/Narrasil Marsh.png'),
  map_icon_mesa_1('map/icons/Narrasil Mesa 1.png'),
  map_icon_mesa_2('map/icons/Narrasil Mesa 2.png'),
  map_icon_monolith('map/icons/Narrasil Monolith.png'),
  map_icon_mountain_1('map/icons/Narrasil Mountain 1.png'),
  map_icon_mountain_2('map/icons/Narrasil Mountain 2.png'),
  map_icon_mountain_3('map/icons/Narrasil Mountain 3.png'),
  map_icon_mountain_4('map/icons/Narrasil Mountain 4.png'),
  map_icon_mountain_5('map/icons/Narrasil Mountain 5.png'),
  map_icon_mountain_6('map/icons/Narrasil Mountain 6.png'),
  map_icon_mountain_large_1('map/icons/Narrasil Mountain Large 1.png'),
  map_icon_mountain_large_2('map/icons/Narrasil Mountain Large 2.png'),
  map_icon_mountain_large_3('map/icons/Narrasil Mountain Large 3.png'),
  map_icon_mountain_large_4('map/icons/Narrasil Mountain Large 4.png'),
  map_icon_mountain_peak_1('map/icons/Narrasil Mountain Peak 1.png'),
  map_icon_mountain_peak_2('map/icons/Narrasil Mountain Peak 2.png'),
  map_icon_oasis('map/icons/Narrasil Oasis.png'),
  map_icon_pine_tree_1('map/icons/Narrasil Pine Tree 1.png'),
  map_icon_pine_tree_2('map/icons/Narrasil Pine Tree 2.png'),
  map_icon_pine_tree_3('map/icons/Narrasil Pine Tree 3.png'),
  map_icon_pine_tree_4('map/icons/Narrasil Pine Tree 4.png'),
  map_icon_pine_tree_5('map/icons/Narrasil Pine Tree 5.png'),
  map_icon_pine_tree_6('map/icons/Narrasil Pine Tree 6.png'),
  map_icon_ridge('map/icons/Narrasil Ridge.png'),
  map_icon_ruin_large('map/icons/Narrasil Ruin Large.png'),
  map_icon_ruin_small('map/icons/Narrasil Ruin Small.png'),
  map_icon_square_tower('map/icons/Narrasil Square Tower.png'),
  map_icon_standing_stones('map/icons/Narrasil Standing Stones.png'),
  map_icon_stronghold('map/icons/Narrasil Stronghold.png'),
  map_icon_swamp('map/icons/Narrasil Swamp.png'),
  map_icon_three_towers('map/icons/Narrasil Three Towers.png'),
  map_icon_tower('map/icons/Narrasil Tower.png'),
  map_icon_town('map/icons/Narrasil Town.png'),
  map_icon_tree_1('map/icons/Narrasil Tree 1.png'),
  map_icon_tree_2('map/icons/Narrasil Tree 2.png'),
  map_icon_tree_3('map/icons/Narrasil Tree 3.png'),
  map_icon_tree_4('map/icons/Narrasil Tree 4.png'),
  map_icon_tree_5('map/icons/Narrasil Tree 5.png'),
  map_icon_tree_6('map/icons/Narrasil Tree 6.png'),
  map_icon_village('map/icons/Narrasil Village.png'),
  map_icon_volcano_active('map/icons/Narrasil Volcano Active.png'),
  map_icon_volcano_dormant('map/icons/Narrasil Volcano Dormant.png'),
